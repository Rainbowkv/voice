...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{ 1.5, "近" }, -- Whisper speech distance in gta distance units
		{ 3.0, "中" },  -- Normal speech distance in gta distance units
		{ 6.0, "远" } -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{ 3.0,  "近" }, -- Whisper speech distance in gta distance units
		{ 7.0,  "中" },  -- Normal speech distance in gta distance units
		{ 15.0, "远" } -- Shout speech distance in gta distance units
	}
end
